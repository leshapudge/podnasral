...
export const MC_MODIFIER_ITEMS: CatalogItemSeed[] = [
  ...
  },
  {
    ...
    name: "Компас путника",
    description: "+2 игры на аукционе и переброс сложности для аутсайдеров.",
    rarity: "RARE",
    kind: "MODIFIER",
  ...
  },
  {
    ...
    name: "Запечатанная бочка",
    description: "Аукцион чаще даёт короткие игры; +1 спин слота наград.",
    rarity: "UNCOMMON",
    kind: "MODIFIER",
  ...
  },
  {
    slug: "genre_expert",
    name: "Книга рецептов",
    description: "Аукцион смещён к средним играм 15–35 ч HLTB.",
    rarity: "RARE",
    kind: "MODIFIER",
  ...
  },
  {
    ...
    description: "На длинных играх (15+ ч HLTB): +10% очков за прохождение.",
    rarity: "EPIC",
    kind: "MODIFIER",
  ...
  },
  {
    ...
    name: "Пластинка «13»",
    description: "Длинные игры на аукционе; +12% очков на HLTB 25+ ч.",
    rarity: "EPIC",
    kind: "MODIFIER",
  ...
  },
  {
    ...
    description: "Аукцион до 10 ч HLTB; +15 очков при победе.",
    rarity: "RARE",
    kind: "MODIFIER",
